...
Пример запуска:
    py -3.14 hh_to_sqlite.py -q "руководитель проектов АСУ ТП, инженер АСУ ТП, программист АСУ ТП, программист ПЛК, SCADA, проектировщик АСУ ТП, инженер ПНР, инженер КИПиА, инженер КИП, инженер-проектировщик, инженер-конструктор, наладчик, инженер, технолог, инженер-проектировщик, специалист по пусконаладке" --contact "tg:@promsoftservice" --db employers.db
